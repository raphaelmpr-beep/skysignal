  ...
  return (
    <ToastPrimitive.Root
      ...
      className={cn(
        ...
        variant === 'default' && 'bg-[#162030] border-white/10 text-foreground',
        variant === 'destructive' && 'bg-red-900/30 border-red-500/30 text-red-400',
        variant === 'success' && 'bg-green-900/30 border-green-500/30 text-green-400',
        className
      )}
      {...props}
    />
